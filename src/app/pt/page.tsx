...
export const metadata: Metadata = {
  title: "Ferramentas Online Gratuitas e Privadas | Utilify Português",
  description: "Suite gratuita de ferramentas para juntar e dividir PDF, remover fundo de fotos com IA, comprimir imagens e calcular investimentos em português.",
  alternates: {
    canonical: "/pt",
    languages: {
  ...
  openGraph: {
    title: "Ferramentas Online Gratuitas e Privadas | Utilify Português",
    description: "Suite gratuita de ferramentas para PDF, imagens e calculadoras sem cadastro e com total privacidade.",
    url: "https://www.theutilify.com/pt",
    siteName: "Utilify",
    locale: "pt_BR",
    type: "website",
  },
...
export default function PortugueseHubPage() {
  const t = hubTranslations.pt;
  const tools = Object.values(toolTranslations.pt);
        ...
        <section className="py-16 md:py-24 border-b bg-card/50 relative overflow-hidden text-center">
          <div className="container max-w-4xl mx-auto px-4 relative z-10">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 text-xs font-bold text-muted-foreground">
              <span className="flex items-center gap-1.5"><ShieldCheck className="h-4 w-4 text-green-500" /> Zero armazenamento</span>
              <span className="flex items-center gap-1.5"><Zap className="h-4 w-4 text-amber-500" /> 100% no seu navegador</span>
              <span className="flex items-center gap-1.5"><Sparkles className="h-4 w-4 text-primary" /> Sem marcas d&apos;água</span>
            </div>
          </div>
        </section>
